...
public class PlayerConfiguratorAssetReferenceGameObject : MonoBehaviour
{
    [SerializeField]
    ...
    {
        // Find out if the value chosen in the object picker is a valid address. 
        // In this context, it will forbid LoadAssetAsync from being called if the AssetReference is set to None.
